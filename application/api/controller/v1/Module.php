...
class Module extends BaseController
{
    ...
    /**
     * @api {POST} /api/v1/module/system/canteen/save CMS管理端-新增系统功能模块
     * @apiGroup   CMS
     * @apiVersion 3.0.0
    ...
    /**
     * @api {GET} /api/v1/modules  CMS管理端-获取系统模块
     * @apiGroup  CMS
     * @apiVersion 3.0.0
     * @apiDescription CMS管理端-获取系统模块
     * @apiExample {get}  请求样例:
     * http://canteen.tonglingok.com/api/v1/modules
    ...
    {
        $modules = (new ModuleService())->systemModules();
    ...
    /**
     * @api {POST} /api/v1/module/system/handel CMS管理端-功能模块状态操作
     * @apiGroup   CMS
     * @apiVersion 3.0.0
     * @apiDescription    CMS管理端-功能模块状态操作
     * @apiExample {post}  请求样例:
     *    {
     *       "id": 1,
     *       "state":1
    ...
    /**
     * @api {POST} /api/v1/module/update CMS管理端-修改系统模块
     * @apiGroup   CMS
     * @apiVersion 3.0.0
     * @apiDescription   CMS管理端-修改系统模块
     * @apiExample {post}  请求样例:
     *    {
     *       "id": 1,
     *       "name": "设置"
    ...
    /**
     * @api {POST} /api/v1/module/default/handel CMS管理端-系统模块-默认模块状态
     * @apiGroup   CMS
     * @apiVersion 3.0.0
     * @apiDescription   CMS管理端-系统模块-默认模块状态
     * @apiExample {post}  请求样例:
     * {"modules":[{"id":1,"default":1},{"id":2,"default":2}]}
    ...
    /**
     * @api {GET} /api/v1/modules/canteen/withSystem  CMS管理端-获取企业模块功能模块:包括系统模块
     * @apiGroup  CMS
     * @apiVersion 3.0.0
    ...
    /**
     * @api {POST} /api/v1/module/company/update CMS管理端-修改企业模块
     * @apiGroup   CMS
     * @apiVersion 3.0.0
     * @apiDescription   CMS管理端-修改企业模块
     * @apiExample {post}  请求样例:
     *    {
     *       "company_id":1,
     *       "canteen":{"add_modules":[{"m_id":1,"order":4},{"m_id":2,"order":5}],"cancel_modules":"3,4"},
     *     }
     ...
     * @apiSuccess (返回参数说明) {String} msg 信息描述
     * @apiSuccess (返回参数说明) {int} id 模块id
     * @apiSuccess (返回参数说明) {int} c_m_id 企业模块关联id
     * @apiSuccess (返回参数说明) {int} category 企业内部模块类别：1|普通模块；2|特殊模块
     * @apiSuccess (返回参数说明) {string} url 模块路由
     * @apiSuccess (返回参数说明) {string} name 模块名称
     * @apiSuccess (返回参数说明) {int} type  模块类别：1|pc;2|手机端
     * @apiSuccess (返回参数说明) {string} create_time 创建时间
    ...
    /**
     * @api {POST} /api/v1/canteen/module/category CMS管理端-功能模块属性修改
     * @apiGroup   CMS
     * @apiVersion 3.0.0
     * @apiDescription  CMS管理端-功能模块属性修改
     * @apiExample {post}  请求样例:
     *    {
     *       "c_m_id": 1,
     *       "category":1
     *     }
     * @apiParam (请求参数说明) {int} c_m_id  企业和模块关联id：来自于接口：/api/v1/modules/company/canteen
    ...
    public function canteenModuleCategoryHandel()
    {
        ...
        $res = CanteenModuleT::update(['category' => $category], ['id' => $c_m_id]);
        if (!$res) {
