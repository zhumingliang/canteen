...
/*    public function punishStaff()
    ...
    public static function exportPunishStaff($company_id, $meal, $canteen_id, $department_id, $staff_name, $time_begin, $time_end)
    {
    ...
    public static function punishStaff($company_id, $meal, $canteen_id, $department_id, $staff_name, $time_begin, $time_end,$page,$size)
    {
        $time_end = addDay(1, $time_end);
        return self::alias('a')
            ->leftJoin('canteen_canteen_t b', 'a.canteen_id=b.id')
